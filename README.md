# 👋 Hi, I'm Dariush Kazemi

<div align="center">
  
![Data Scientist Badge](https://img.shields.io/badge/Data%20Scientist-Machine%20Learning-blue?style=for-the-badge)
![Data Engineer Badge](https://img.shields.io/badge/Data%20Engineer-Real%20Time%20Systems-orange?style=for-the-badge)
...
I'm a **Data Engineer** and **Data Scientist** with Ph.D. studies at the University of Tehran, specializing in **real-time data systems**, **Graph Neural Networks**, and **Machine Learning**. With extensive experience spanning data engineering, AI research, and industry applications, I develop innovative solutions at the intersection of big data, AI, and distributed systems.

### 🎯 Current Focus
- ⚡ **Data Engineering**: Real-time data synchronization and distributed systems
...
### ⚡ **Data Engineer** | *OnTime*
*Jan 2025 - Present*
- 🔄 Implemented **real-time data synchronization** between PostgreSQL and Neo4j using **Apache Kafka** with CDC patterns
- 🤖 Designed **Graph Neural Network (GNN) recommender system** for personalized event and mentor matching  
- 🚀 Managed deployment at **INOTEX 2025** (Pardis Technology Park, April 29 - May 2), handling **3500+ active users** with innovative live event recommendations

### 🔬 **Research Collaborator** | *University of Tehran* 
*Jan 2025 - Present*
...
*Mar 2024 - Present*
- 🧪 Pioneered **ML-based analysis** of genotype/phenotype data from HPO, OMIM, and Orphanet
- 🏗️ Architected **Neo4j databases** to power personalized genomic analysis
- 📊 Built **genetic whole-exome database** for expert advisor application

### 🚀 **AI Consultant & System Advisor** | *Kar Center*
*Feb 2024 - Mar 2024*
- 💡 Designed **AI-driven recommender systems** and fraud detection for dating app
- 🔍 Advised advanced algorithm development and system integration
- 🤝 Collaborated with cross-functional teams for AI-driven solutions

### 🔧 **Data Engineer** | *Selected Geeks*
*Jun 2023 - Aug 2023*
- 🕷️ Led backend development of **distributed data crawling system**
- ⚡ Optimized storage and retrieval for large-scale data processing
...
### 🎯 **Real-Time Event Recommendation System** | *OnTime*
- ⚡ **Apache Kafka CDC** for real-time PostgreSQL ↔ Neo4j synchronization
- 🧠 **Graph Neural Network** recommender for events and mentors
- 🏆 Successfully deployed at **INOTEX 2025** serving **3500+ users**
...
| **Design & Analysis of Algorithms** | Amirkabir University | 2022-2023 | Graph theory, ML concepts, coding assignments |
| **Advanced Programming** | University of Guilan | 2019 | Java programming & algorithmic challenges |

### 💻 **Technical Support Experience**
- **Computer & IT Technician** | *Gilan Pardazesh/Dana Clinic* (2015-2023)
  - System support and data maintenance across multiple healthcare facilities
